/*
 * csz_light_cone.h -- CSOZ renderer: world-space visible flashlight beam volume (L6a)
 *
...
{
struct ViewSetup;
// L6a third-person visible flashlight beam. A world-space additive cone-mesh
// rendered at each registered spot: the air in-scatter glow visible from ANY
